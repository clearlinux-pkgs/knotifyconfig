...
Source0  : https://download.kde.org/stable/frameworks/5.85/knotifyconfig-5.85.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.85/knotifyconfig-5.85.0.tar.xz.sig
...
%prep
%setup -q -n knotifyconfig-5.85.0
cd %{_builddir}/knotifyconfig-5.85.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630903863
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knotifyconfig-5.85.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/knotifyconfig/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5NotifyConfig.so.5.85.0
