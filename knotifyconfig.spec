...
Source0  : https://download.kde.org/stable/frameworks/6.10/knotifyconfig-6.10.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.10/knotifyconfig-6.10.0.tar.xz.sig
...
%setup -q -n knotifyconfig-6.10.0
cd %{_builddir}/knotifyconfig-6.10.0
pushd ..
cp -a knotifyconfig-6.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736736086
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6NotifyConfig.so.6.10.0
/usr/lib64/libKF6NotifyConfig.so.6
/usr/lib64/libKF6NotifyConfig.so.6.10.0
