...
%setup -q -n knotifyconfig-6.2.0
cd %{_builddir}/knotifyconfig-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715642437
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6NotifyConfig.so.6.2.0
/usr/lib64/libKF6NotifyConfig.so.6
/usr/lib64/libKF6NotifyConfig.so.6.2.0
