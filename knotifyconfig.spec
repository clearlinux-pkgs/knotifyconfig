...
Version  : 6.12.0
Release  : 88
URL      : https://download.kde.org/stable/frameworks/6.12/knotifyconfig-6.12.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.12/knotifyconfig-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/knotifyconfig-6.12.0.tar.xz.sig
...
%setup -q -n knotifyconfig-6.12.0
cd %{_builddir}/knotifyconfig-6.12.0
pushd ..
cp -a knotifyconfig-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742573624
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6NotifyConfig.so.6.12.0
/usr/lib64/libKF6NotifyConfig.so.6
/usr/lib64/libKF6NotifyConfig.so.6.12.0
