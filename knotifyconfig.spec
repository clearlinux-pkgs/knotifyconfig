...
%prep
%setup -q -n knotifyconfig-5.87.0
cd %{_builddir}/knotifyconfig-5.87.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634482973
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knotifyconfig-5.87.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/knotifyconfig/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5NotifyConfig.so.5.87.0
