...
Version  : 5.113.0
Release  : 67
URL      : https://download.kde.org/stable/frameworks/5.113/knotifyconfig-5.113.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.113/knotifyconfig-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/knotifyconfig-5.113.0.tar.xz.sig
...
%prep
%setup -q -n knotifyconfig-5.113.0
cd %{_builddir}/knotifyconfig-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703012582
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5NotifyConfig.so.5.113.0
/usr/lib64/libKF5NotifyConfig.so.5
/usr/lib64/libKF5NotifyConfig.so.5.113.0
