...
Source0  : https://download.kde.org/stable/frameworks/5.105/knotifyconfig-5.105.0.zip
...
%prep
%setup -q -n knotifyconfig-5.105.0
cd %{_builddir}/knotifyconfig-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681755368
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5NotifyConfig.so.5.105.0
