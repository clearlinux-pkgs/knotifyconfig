...
Source0  : https://download.kde.org/stable/frameworks/5.59/knotifyconfig-5.59.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.59/knotifyconfig-5.59.0.tar.xz.sig
...
%prep
%setup -q -n knotifyconfig-5.59.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1560034947
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5NotifyConfig.so.5.59.0
